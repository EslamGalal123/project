...
class NervousSystem extends StatefulWidget {
  ...
  @override
  State<NervousSystem> createState() => _TeethState();
}

class _TeethState extends State<NervousSystem> {
  _TeethState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:  ListView(
          children: [
            title(name_of_page: 'NervousSystem'),
            condition(description: ' condition of your nervoussystem',),
            Column(
