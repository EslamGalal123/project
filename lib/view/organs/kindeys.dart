...
class Kindeys extends StatefulWidget {
  const Kindeys({super.key});

  @override
  State<Kindeys> createState() => _TeethState();
}

class _TeethState extends State<Kindeys> {
  _TeethState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:  ListView(
          children: [
            title(name_of_page: 'Kindeys'),
            condition(description: ' condition of your Kindeys',),
            Column(
